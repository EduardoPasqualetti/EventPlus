...
// Configuracoes do servico de moderacao de conteudo - Azure

builder.Services.AddSingleton(provider => new ContentModeratorClient(
    new ApiKeyServiceClientCredentials("49c5b88b53fb4610889e9f70e63d45e8"))
{
    Endpoint = "https://eventmoderator-eduardop.cognitiveservices.azure.com/"
}
);
